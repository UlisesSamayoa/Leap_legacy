...
namespace LEAP.Controllers
{
    ...
    public class LoginController : Controller
    {
        ...
        public ActionResult ValidateLogin(string username, string Pass_word)
        {
            ...
            if (IsValidUser)
            {
                // El token de leap_api + Type_User/specialist viajan (serializados,
                // ver AuthTicketData) en userData del ticket (encriptado dentro de
                // la cookie de auth) para no depender de sesion de servidor —
                // ApiClient/AuthContext los leen de ahi en cada llamada.
                ...
                var authTicket = new FormsAuthenticationTicket(1, username, DateTime.Now, DateTime.Now.AddMinutes(FormsAuthentication.Timeout.TotalMinutes), false, _login.TicketData);
